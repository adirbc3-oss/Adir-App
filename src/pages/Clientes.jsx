                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
                    <div>
                        ...
                        <p style={{ margin: '4px 0 0', color: 'var(--text-muted)', fontSize: '0.9rem' }}>
                            Directorio de clientes y empresas. El email se asocia automáticamente
                            cuando llega un BC3 por correo.
                        </p>
                    </div>
                    <button
                            ...
                            {filteredClientes.map((c, i) => {
                                ...
                                return (
                                    <React.Fragment key={c.id}>
                                        <tr
                                            style={{ borderBottom: isExpanded ? 'none' : '1px solid var(--border-color)', background: rowBg, cursor: 'default' }}
                                        ...
                                        {/* Fila expandida con dirección y notas */}
                                        {isExpanded && (
                            ...
                            {formFields.map(({ key, label, type, icon }) => (
                                <div key={key}>
                                    ...
                                    <input
                                        ...
                                        onKeyDown={e => { if (e.key === 'Enter' && key !== 'notas') handleSave(); }}
                                    />
                                </div>
                            ))}
                            <div>
